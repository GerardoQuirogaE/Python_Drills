"""
Today we are creating a console GUI Console

I got this code from cli-chess library on github.
"""
...
"""
This class is like the entire screen of the application. """
class MainView:
    def __init__(self, presenter: MainPresenter):
        try:
            ...
            #This builds the screen layout
            self._container = self._create_main_container()

            """
            This creates the full terminal interface."""
    ...
    def _create_main_container(self):
        ...
        HSplit   → vertical stacking
        VSplit   → horizontal stacking
        Window   → actual UI area
        Box      → padding wrapper
        """
        return HSplit([
            VSplit([
